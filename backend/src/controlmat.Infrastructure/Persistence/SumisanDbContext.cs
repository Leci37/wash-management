...
public class SumisanDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        // ✅ MACHINES Table Configuration
        modelBuilder.Entity<Machine>(entity =>
        {
            entity.HasKey(e => e.Id);
            entity.Property(e => e.Id).ValueGeneratedNever(); // Manually assigned
            entity.Property(e => e.Name)
                .IsRequired()
                .HasMaxLength(50);
        });

        // ✅ WASHINGS Table Configuration
        modelBuilder.Entity<Washing>(entity =>
        {
            entity.HasKey(e => e.WashingId);
            entity.Property(e => e.WashingId).ValueGeneratedNever(); // Generated in handler
