namespace Controlmat.Domain.Entities
{
    public class User
    {
        ...
        // Business methods
        public bool CanManageWashes() => IsActive && (Role == "WarehouseUser" || Role == "Supervisor");
        public bool CanViewReports() => IsActive && (Role == "Supervisor" || Role == "Administrator");
        public bool IsAdministrator() => IsActive && Role == "Administrator";
    }
}
